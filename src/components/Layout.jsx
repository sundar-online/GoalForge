...
export const Layout = ({ children, currentView, setView }) => {
  return (
    <div className="min-h-screen bg-bg-app font-sans transition-colors duration-300 flex flex-col lg:flex-row">
      {/* Desktop Sidebar */}
      <aside className="hidden lg:flex w-64 lg:w-72 flex-col bg-bg-card border-r border-border-light h-screen sticky top-0 p-6 z-50">
      ...
      <main className="flex-1 min-h-screen relative overflow-x-hidden">
        <div className="w-full max-w-screen-xl mx-auto p-4 sm:p-6 lg:p-10 pb-32 lg:pb-10">
          {children}
        </div>
