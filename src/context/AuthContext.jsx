...
function firebaseMsg(code) {
  const map = {
    ...
    'auth/user-not-found':                           'No account found with this email. If you signed up with Google, use "Continue with Google".',
    'auth/wrong-password':                           'Incorrect password. If you signed up with Google, use "Continue with Google" or reset your password.',
    ...
    'auth/invalid-credential':                       'Invalid credentials. If you signed up with Google, use "Continue with Google" or reset your password.',
